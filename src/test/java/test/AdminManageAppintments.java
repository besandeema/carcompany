...
public class AdminManageAppintments {
    ...
    Installer installer;
    Installer installer111= new Installer(1, "installerrbesann", "besannn@najah","123","installer","11/12/2023");
    Installer installer222= new Installer(222, "installerrRRbesann", "besannn@najah","123","installer","11/12/2023");
    public static List<Appointment> appointmentList=new ArrayList<>();
    public static List<Installer> installersDatabase = new ArrayList<>();
    Appointment appointment111=new Appointment("besan","11/12/2002","bb","2012");
